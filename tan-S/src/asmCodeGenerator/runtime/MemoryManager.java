...
public class MemoryManager {
    // Debug Mode. DEBUGGING Adds debug code and executes insertDebugMain when the program is
    // initialized.
    ...
    // this goes after the main program, so that MEM_MANAGER_HEAP is after all other variable
    // declarations.
