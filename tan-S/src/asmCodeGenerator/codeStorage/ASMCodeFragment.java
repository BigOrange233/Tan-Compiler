...
public class ASMCodeFragment {
    ...
    /**
     * Append all instructions in the argument to this code fragment. This does not change the type
     * of this code fragment; you must call markAsXXX afterwards if you need that to happen.
     * 
     * @param fragment
     */
