...
/**
 * This class is a Facade for java.util.logging. It also retains the number of messages that have
 * been logged. Optionally, one may configure this logger to throw an exception when a certain
 * message count is reached.
 * <p>
