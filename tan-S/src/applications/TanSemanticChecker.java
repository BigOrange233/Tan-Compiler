...
public class TanSemanticChecker extends TanApplication {
    /**
     * Checks semantics of a tan file. Prints filename and "done" if syntax is correct; prints
     * errors if not.
     * 
     * @param args
    ...
    /**
     * analyzes a file specified by filename and prints a decorated syntax tree for the file.
     * 
     * @param filename the name of the file to be analyzed.
     * @param out the PrintStream to print the decorated tree to.
     * @throws FileNotFoundException
     */
    public static void checkFileSemantics(String filename, PrintStream out)
            throws FileNotFoundException {
