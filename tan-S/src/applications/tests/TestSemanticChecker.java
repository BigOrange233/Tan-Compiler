...
import applications.TanSemanticChecker;
...
public class TestSemanticChecker extends FileFixturesTestCase {
    ...
    public void semanticCheckerSingleTest(Level level, Tokens.Level tokenLevel, String string)
            throws Exception {
    ...
    public class ASTCommand implements Command {
        ...
        public void run(PrintStream out) throws FileNotFoundException {
            TanSemanticChecker.checkFileSemantics(filename, out);
        }
    }
}
