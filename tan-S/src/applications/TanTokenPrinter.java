...
public class TanTokenPrinter extends TanApplication {
    /**
     * Prints tokens from a tan file.
     * 
     * @param args
    ...
    /**
     * prints the tan tokens in the file specified by filename to the given PrintStream.
     * 
